...
TArray<FArmyUnitInfoStruct> UArmy::GetArmyUnits(int32 InArmyID)
{
    ...
    while (ArmyUnitsTable->Step() == ESQLitePreparedStatementStepResult::Row)
    {
        ...
        ArmyUnitsTable->GetColumnValueByName(TEXT("ArmyName"), ArmyUnitInfo.ArmyName);
